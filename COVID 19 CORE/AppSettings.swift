...
extension String {
    ...
    struct MessageHandler {
        public static let CT_START      =   "start"
        public static let CT_REQUEST    =   "request_bt"
        public static let CT_PAUSE      =   "pause"
        public static let CT_SYNC       =   "sync_exposed_user"
        public static let CT_GETTOKENS  =   "get_data"
        public static let CT_SETEXPOSED =   "set_exposed"
        public static let CT_RESET      =   "stop_exposed_notifications"
        public static let CT_CLEAN_DATA =   "clean_data"
        public static let CT_STATUS     =   "getBTStatus"
        public static let CT_EXPOSED_LENGTH =   "getExposedLength"
        public static let CT_GET_WINDOWS    =   "getWindowLength"
        public static let CT_CLEAR_WINDOWS  =   "clearWindowLength"
        
        public static let LOCATION_INIT =   "request_gps"
        public static let LOCATION_DATA =   "get_location_data"
        
        public static let SHARE_APP     =   "share_app"
        
        public static let TOKEN_GET     =   "getToken"
        
        public static let GOTO_SETTINGS =   "openAppSettings"
        
        public static let QR_READ       =   "readQR"
        public static let QR_ERROR      =   "readQRError"
        
        public static let GET_CONTACTS  =   "getContacts"
        
        public static let GET_LOGS      =   "getLogs"
...
struct AppSettings {
    ...
    static var gpsRequested: Bool {
        get {
            return UserDefaults.standard.bool(forKey: "GPS_REQUESTED")
        }
        set {
            UserDefaults.standard.set(newValue, forKey: "GPS_REQUESTED")
        }
    }

    static var lastGPSData:Date {
        get {
            let timeInterval = UserDefaults.standard.integer(forKey: "LAST_GPD_DAtA")
            return Date(timeIntervalSince1970: TimeInterval(timeInterval))
        }
        set {
            UserDefaults.standard.set(Int(newValue.timeIntervalSince1970), forKey: "LAST_GPD_DAtA")
        }
    }
    ...
    static func logOut() {
        ...
        if AppSettings.bluetoothRequested, String.General.CONTACT_TRACING_MODEL != .none {
            AppSettings.bluetoothRequested = false
            ContactTracingManager.sharedInstance.stopTracing()
        }
        (UIApplication.shared.delegate as? AppDelegate)?.stopAllMotion()
