...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var isShowingContacts:Bool = false
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        if (self.window?.rootViewController as? ViewController)?.isLoadWeb ?? false {
            ...
            if !self.isShowingContacts {
                NotificationCenter.default.post(name: NSNotification.Name.handleReload, object:self.openUrl)
            }
        }
        
        self.isShowingContacts = false
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        if String.General.CONTACT_TRACING_MODEL != .none, AppSettings.bluetoothRequested {
            ...
            self.triggerCalendarLocalPushNotifications(pnContent: PushNotificationConstants.dailyRemPushNotifContents[magicNumber], identifier: "appBackgroundNotifId")
        }
    ...
    func triggerCalendarLocalPushNotifications(pnContent: [String: String], identifier: String) {
        ...
        content.userInfo = [
            "aps":  [
                ...
                "sound":        "default",
                "type":         "url",
                "element":      "\(String.Webapp.URL)main/bt-status\(String.Webapp.PARAMS)"
            ]
        ]
