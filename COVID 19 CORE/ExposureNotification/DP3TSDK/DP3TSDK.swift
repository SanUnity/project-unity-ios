...
class DP3TSDK {
    ...
    init(applicationDescriptor: ApplicationDescriptor, urlSession: URLSession, backgroundHandler: DP3TBackgroundHandler?, configuration: ENExposureConfiguration?, factorLow: Double?, factorHigh: Double?, triggerThreshold: Int?) throws {
        ...
        matcher = ExposureNotificationMatcher(manager: manager, exposureDayStorage: exposureDayStorage, configuration: configuration, factorLow: factorLow, factorHigh: factorHigh, triggerThreshold: triggerThreshold)
